package com.capstone.capstonedesign.configuration;

import com.capstone.capstonedesign.service.support.JwtTokenProvider;
import com.capstone.capstonedesign.web.filter.JwtAuthFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers("/sign-in", "/sign-up", "/stream").permitAll()
